const texts = {
    ...
    loginAndRegister:{
        ...
        loginToContinue: "Entre para continuar planejando suas aventuras.",
        forgotPassword: "Esqueci minha senha",
        emailOrPasswordInvalid: "Email ou senha inválidos",
        createYourAccount: "Crie sua conta",
        createYourAccountText: "É rápido, fácil e grátis.",
        name: "Nome de usuário",
        namePlaceholder: "Ex: viajante_explorador",
        email: "Email",
        emailPlaceholder: "seu@email.com",
        password: "Senha",
        passwordPlaceholder: "Sua senha",
        createPassword: "Criar Senha",
        createPasswordPlaceholder: "Crie sua senha",

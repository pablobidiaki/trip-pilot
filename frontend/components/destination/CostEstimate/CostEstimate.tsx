    ...
    return (
        <div className="min-w-2/7 mt-10 mx-4">
            ...
            <div className="bg-white p-2 rounded-2xl border border-gray-200 h-fit">
                ...
                <InfoRow icon={<Car />} information={texts.costEstimate.transport} value={destination[0].averageCost.transport} tailwindTags="px-2 py-3" />
                <hr className="mx-1" />
                <div className="flex justify-between mt-2 mx-2 items-center">
                    <p className="text-primary-color font-bold">{texts.costEstimate.totalEstimate}</p>

    ...
    return (
        <div>
            <div className="my-10 mx-4 grid grid-cols-6 gap-20 ">
                ...
                <DestinationInfos  icon={<CalendarDays size={35} className=""/>} title={texts.destination.recommendedDays} description={`${destination[0].dayReccomended.toString()} ${texts.days}`}/>

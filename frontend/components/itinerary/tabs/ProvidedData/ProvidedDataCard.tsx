...
export default function ProvidedDataCard({icon, title, value}: ProvidedDataCardProps){
    return(
        <div className="mt-5 p-2 rounded-2xl bg-blue-100 flex flex-col items-center min-w-30 max-w-30 transition-all duration-200 hover:scale-105 cursor-default">  

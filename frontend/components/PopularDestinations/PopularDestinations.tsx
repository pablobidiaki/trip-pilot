    ...
    return(
        <div className="mx-4 mt-10">
            <div className="flex items-center justify-between">
                <h1 className="text-primary-color font-medium text-3xl">{texts.home.popular_destination_title}</h1>
                
                <p className="text-link-color underline font-medium">
                    <Link href={"/destinations"}>{texts.home.view_all_destinations}</Link>
                </p>
            </div>

    ...
    return(
        <div className="lg:col-span-8 bg-white p-6 rounded-2xl border border-gray-200 mx-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center p-2 mt-4">
                <GeneralInfoCard image="/imgs/ready_guides/italy.jpg" days="Dia 1 - 3" title="Roma" description="Historia antiga, ruinas e gastronomia. O melhor da italia para voce."/>
